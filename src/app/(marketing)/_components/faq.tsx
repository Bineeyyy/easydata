...
const items: FaqItem[] = [
  ...
  {
    id: "q2",
    q: "Είναι υποχρεωτικό το myDATA;",
    a: "Από 1 Οκτωβρίου 2026, ναι. Όλοι οι ελεύθεροι επαγγελματίες και οι μικρές επιχειρήσεις στην Ελλάδα υποχρεούνται να εκδίδουν τιμολόγια ηλεκτρονικά μέσω myDATA. Πρόστιμα ξεκινούν από €500.",
  },
  {
    id: "q3",
