...
const items: FaqItem[] = [
  ...
  },
  {
    id: "q5",
    q: "Πόσο θα κοστίζει;",
    a: "Τρία πλάνα. Δωρεάν: έως 5 τιμολόγια/μήνα, με τα βασικά. Δωρεάν για πάντα: απεριόριστα τιμολόγια lifetime — μόνο για τους πρώτους 50 στη λίστα, καθόλου κάρτα, καθόλου χρέωση ποτέ. Pro: €5/μήνα, απεριόριστα τιμολόγια, AI ταξινόμηση, mobile-first — για όσους έρχονται μετά τους πρώτους 50.",
  },
  {
    id: "q6",
    q: "Πότε ανοίγει;",
