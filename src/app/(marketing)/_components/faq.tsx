...
const items: FaqItem[] = [
  ...
  },
  {
    id: "q5",
    q: "Πόσο θα κοστίζει;",
    a: "Τρία πλάνα. Δωρεάν: έως 5 τιμολόγια/μήνα, με τα βασικά. Pro: €7/μήνα, απεριόριστα τιμολόγια, AI ταξινόμηση, mobile-first. Early bird: €5/μήνα κλειδωμένο για πάντα — μόνο για τους πρώτους 100 στη λίστα.",
  },
  {
    id: "q6",
    q: "Πότε ανοίγει;",
